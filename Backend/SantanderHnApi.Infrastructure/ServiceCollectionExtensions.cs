...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        var resiliencePolicy = CreateResiliencePolicy(hnOptions);
    ...
    internal static IAsyncPolicy<HttpResponseMessage> CreateResiliencePolicy(HackerNewsOptions options)
    {
        var retryPolicy = HttpPolicyExtensions
            ...
            .WaitAndRetryAsync(
                ...
                retryAttempt =>
                {
                    var baseDelay = TimeSpan.FromSeconds(options.RetryBaseDelaySeconds);
                    var exponential = TimeSpan.FromSeconds(baseDelay.TotalSeconds * Math.Pow(2, retryAttempt - 1));
                    var jitterMs = Random.Shared.Next(0, options.RetryJitterMaxMilliseconds + 1);
        ...
        var circuitBreakerPolicy = HttpPolicyExtensions
            ...
            .CircuitBreakerAsync(
                ...
                durationOfBreak: TimeSpan.FromSeconds(options.CircuitBreakerBreakSeconds));
